...
export async function testSolution(req: Request, res: Response) {
    try {
        ...
        const response = await axios.post("http://codesandbox.code-champ.xyz/submit-batch-task", {
            submissionId: id,
...
export async function checkBatchSubmission(req: Request, res: Response) {
    try {
        ...
        const result = await axios.get(`http://codesandbox.code-champ.xyz/batch-task-status/${taskId}`);
